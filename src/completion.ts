// Completion Provider
import { CancellationToken, CompletionContext, CompletionItem, CompletionItemKind, CompletionTriggerKind, languages, Position, ProviderResult, TextDocument, workspace } from "vscode";
